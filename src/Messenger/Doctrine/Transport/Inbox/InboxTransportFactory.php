...
class InboxTransportFactory implements TransportFactoryInterface
{
    ...
    {
        $options['table_name'] = $options['table_name'] ?? 'z_inbox';
        $options['index_table_name'] = $options['index_table_name'] ?? $options['table_name'].'_index';
        $options['deduplicate'] = $options['deduplicate'] ?? true;
        ...
        return new InboxTransport($connection, $serializer);
    }
