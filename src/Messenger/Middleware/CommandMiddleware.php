    ...
    public function handle(Envelope $envelope, StackInterface $stack): Envelope
    {
        if ($envelope->all(ReceivedStamp::class)) {
            ...
            if ($canHandleLocally) {
                ...
                // Remote commands via gRPC — to be implemented in a future version (when PHP/FrankenPHP has native support for gRPC server)
                throw new \RuntimeException('The command message can not be executed synchronously!');
            }
        }
